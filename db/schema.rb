...
ActiveRecord::Schema[7.0].define(version: 2024_02_09_014849) do
  ...
  create_table "addresses", charset: "utf8", force: :cascade do |t|
    ...
    t.index ["buying_id"], name: "index_addresses_on_buying_id"
  end

  create_table "buyings", charset: "utf8", force: :cascade do |t|
  ...
  add_foreign_key "addresses", "buyings"
